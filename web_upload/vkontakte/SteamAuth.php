...
class SteamAuth
{
    ...
    public function __construct($apikey = null, $domainname = null, $loginpage = null, $logoutpage = null, $skipAPI = false)
    {
        ...
        $this->settings["logoutpage"] = /* [ */(!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['SCRIPT_NAME'];
        $this->settings["skipAPI"] = $skipAPI;
        // Start a session if none exists
        if ($this->settings["apikey"] == "") {
            die("<b>SteamAuth:</b> Please supply a valid API-Key!");
        }
        $this->settings["loginpage"] = /* [ */(!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['SCRIPT_NAME'] . '?reg=' . $_GET['reg'] . '&';
    ...
    public function logout()
    {
        ...
        return $this->settings["logoutpage"];
    }
